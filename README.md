...
| 💡 [Axon Sales Insights](https://github.com/adwaninitesh/axon_sales_insights) | Sales Insights, Interactive Dashboard, KPI , Data Visualization| This repo serves as the solution of Managing sales, KPI and able to Answer business problem for the Axon Car seller, Analysis and KPI's from the [Axon](https://github.com/adwaninitesh/axon_sales_insights). It showcases my ability to tackle various Sales Insights and demonstrates my proficiency in Visualization  writing and problem-solving skills. | 
| 💡 [Customer_Retention](https://github.com/adwaninitesh/Customer_Churn_Analysis) | Sales Insights, Interactive Dashboard, KPI , Data Visualization| This repo serves as the solution of Managing sales, KPI and able to Answer business problem for the Axon Car seller, Analysis and KPI's from the [Churn Analysis](https://github.com/adwaninitesh/Customer_Churn_Analysis). It showcases my ability to tackle various Sales Insights and demonstrates my proficiency in Visualization  writing and problem-solving skills. | 
